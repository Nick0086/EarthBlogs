...
function LoginForm() {
    ...
    return (
        <div className='bg-gray-100' >
            <div className='md:py-40 py-20 container min-h-screen  flex justify-center items-center' >
                <div className='lg:w-2/4 md:w-2/3 w-full bg-white mx-auto rounded-xl loginform' >
